...
namespace ECSEngine {
	...
	static Stream<char> GetEntityNameTempStorageImplementation(
		...
		static thread_local char _storage[ECS_KB];
	...
	Stream<char> GetEntityNameTempStorage(const EntityManager* entity_manager, Entity entity) {
		return GetEntityNameTempStorageImplementation(entity_manager, entity, GetEntityName);
	}
	
	Stream<char> GetEntityNameIndexOnlyTempStorage(const EntityManager* entity_manager, Entity entity) {
		return GetEntityNameTempStorageImplementation(entity_manager, entity, GetEntityNameIndexOnly);
	}

	Stream<char> GetEntityNameExtendedTempStorage(const EntityManager* entity_manager, Entity entity) {
		return GetEntityNameTempStorageImplementation(entity_manager, entity, GetEntityNameExtended);
	}
