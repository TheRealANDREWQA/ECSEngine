...
namespace ECSEngine {
	...
	namespace Tools {
		...
		constexpr size_t UI_CONFIG_SLIDER_PARAMETERS = (size_t)1 << 40;
		constexpr size_t UI_CONFIG_SLIDER_MOUSE_DRAGGABLE = (size_t)1 << 41;
		constexpr size_t UI_CONFIG_SLIDER_ENTER_VALUES = (size_t)1 << 42;
		constexpr size_t UI_CONFIG_SLIDER_CHANGED_VALUE_CALLBACK = (size_t)1 << 43;
		constexpr size_t UI_CONFIG_SLIDER_DEFAULT_VALUE = (size_t)1 << 44;
		...
		constexpr size_t UI_CONFIG_COLOR_INPUT_SLIDERS = (size_t)1 << 45;
		constexpr size_t UI_CONFIG_COLOR_INPUT_NO_NAME = (size_t)1 << 46;
		constexpr size_t UI_CONFIG_COLOR_INPUT_DO_NOT_CHOOSE_COLOR = (size_t)1 << 47;
		constexpr size_t UI_CONFIG_COLOR_INPUT_CALLBACK = (size_t)1 << 48;
		constexpr size_t UI_CONFIG_COLOR_INPUT_DEFAULT_VALUE = (size_t)1 << 49;
