...
namespace ECSEngine {
	...
	namespace Tools {
		...
		ECSENGINE_API void BoolClickableCallback(ActionData* action_data);
		...
		ECSENGINE_API void TimelineChannelHoverableZoomAction(ActionData* action_data);
		
		// --------------------------------------------------------------------------------------------------------------

		ECSENGINE_API void TimelineHeaderClickAction(ActionData* action_data);
