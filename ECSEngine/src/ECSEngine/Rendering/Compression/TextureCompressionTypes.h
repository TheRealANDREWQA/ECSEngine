...
namespace ECSEngine {
	...
	enum ECS_REFLECT ECS_TEXTURE_COMPRESSION_EX : unsigned char {
		...
		ECS_TEXTURE_COMPRESSION_COLOR,
		ECS_TEXTURE_COMPRESSION_CUTOUT,
		ECS_TEXTURE_COMPRESSION_NORMAL_LOW_QUALITY,
		ECS_TEXTURE_COMPRESSION_COLOR_WITH_ALPHA,
		ECS_TEXTURE_COMPRESSION_GRAYSCALE,
		ECS_TEXTURE_COMPRESSION_TANGENT_SPACE_NORMAL,
		ECS_TEXTURE_COMPRESSION_DOUBLE_GRAYSCALE,
		ECS_TEXTURE_COMPRESSION_HDR,
		ECS_TEXTURE_COMPRESSION_COLOR_HIGH_QUALITY
	};
	...
	inline bool IsTextureCompressionTypeValid(ECS_TEXTURE_COMPRESSION_EX compression_type) {
		return (unsigned int)compression_type <= (unsigned int)ECS_TEXTURE_COMPRESSION_COLOR_HIGH_QUALITY;
	}

	inline bool IsTextureCompressionTypeValid(ECS_TEXTURE_COMPRESSION compression_type) {
