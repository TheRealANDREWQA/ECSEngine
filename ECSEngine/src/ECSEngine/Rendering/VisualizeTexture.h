...
namespace ECSEngine {
	...
	// This function kmows how to handle typeless formats that might be generated by the convert function
	ECSENGINE_API ResourceView CreateVisualizeTextureView(Graphics* graphics, Texture2D converted_texture, bool temporary = false);
