...
namespace ECSEngine {
	...
	namespace Reflection {
		...
		ECSENGINE_API void GetReflectionBasicFieldTypeString(ReflectionBasicFieldType type, containers::CapacityStream<char>* string);
		...
		// Uses a jump table
		ECSENGINE_API void GetReflectionStreamFieldTypeString(ReflectionStreamFieldType type, containers::CapacityStream<char>* string);

		ECSENGINE_API ReflectionBasicFieldType ConvertStringToBasicFieldType(containers::Stream<char> string);

		ECSENGINE_API ReflectionStreamFieldType ConvertStringToStreamFieldType(containers::Stream<char> string);
		...
		ECSENGINE_API size_t ConvertReflectionBasicFieldTypeToString(ReflectionBasicFieldType type, const void* data, containers::CapacityStream<char>& characters);
		...
		ECSENGINE_API bool ParseReflectionBasicFieldType(ReflectionBasicFieldType type, containers::Stream<char> characters, void* data);
		...
		ECSENGINE_API ReflectionBasicFieldType DeduceTypeFromString(containers::Stream<char> characters);
