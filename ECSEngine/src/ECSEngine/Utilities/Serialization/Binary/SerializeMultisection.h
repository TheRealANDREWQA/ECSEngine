...
namespace ECSEngine {
	...
	ECSENGINE_API bool SerializeMultisection(Stream<SerializeMultisectionData> data, Stream<wchar_t> file, AllocatorPolymorphic allocator = ECS_MALLOC_ALLOCATOR, Stream<void> header = {nullptr, 0});
