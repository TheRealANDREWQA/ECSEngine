...
struct EditorComponents {
	...
	ComponentFunctions GetAutoGeneratedComponentFunctions(Stream<char> component_name, AllocatorPolymorphic allocator) const;

	SharedComponentCompareEntry GetAutoGeneratedCompareEntry(Stream<char> component_name, AllocatorPolymorphic allocator) const;
