...
struct EditorComponents {
	...
	ComponentFunctions GetAutoGeneratedComponentFunctions(Stream<char> component_name, CapacityStream<void>* stack_memory) const;

	SharedComponentCompareEntry GetAutoGeneratedCompareEntry(Stream<char> component_name, CapacityStream<void>* stack_memory) const;
