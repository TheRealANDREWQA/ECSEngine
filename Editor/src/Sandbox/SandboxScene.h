...
bool ChangeSandboxScenePath(EditorState* editor_state, unsigned int sandbox_handle, ECSEngine::Stream<wchar_t> new_scene);
...
ECSEngine::OrientedPoint GetSandboxCameraPoint(const EditorState* editor_state, unsigned int sandbox_handle, EDITOR_SANDBOX_VIEWPORT viewport);

// -------------------------------------------------------------------------------------------------------------

ECSEngine::Camera GetSandboxCamera(const EditorState* editor_state, unsigned int sandbox_handle, EDITOR_SANDBOX_VIEWPORT viewport);
...
void RenameSandboxScenePath(EditorState* editor_state, unsigned int sandbox_handle, ECSEngine::Stream<wchar_t> new_scene, bool absolute_path = false);
